...
public class EditStudentForm extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.print("<tr><td>Name:</td><td><input type='text' name='name' value='" + bean.getName() + "' class='form-control'/></td></tr>");
        out.print("<tr><td>Email:</td><td><input type='email' name='email' value='" + bean.getEmail() + "' class='form-control'/></td></tr>");
        out.print("<tr><td>Gender:</td><td><input type='text' name='sex' value='" + bean.getSex() + "' class='form-control'/></td></tr>");
        out.print("<tr><td>Course:</td><td><input type='text' name='course' value='" + bean.getCourse() + "' class='form-control'/></td></tr>");
        ...
        out.print("<tr><td>Address:</td><td><textarea name='address' style='width:300px;height:100px;' class='form-control'>" + bean.getAddress() + "</textarea></td></tr>");
        out.print("<tr><td>Contact No:</td><td><input type='tel' name='contact' value='" + bean.getContact() + "' class='form-control' maxlength=\"10\"/></td></tr>");
        out.print("<tr><td colspan='2' align='center'><input type='submit' value='Update Student' class='btn btn-primary'/></td></tr>");
        out.print("</table>");
        out.print("</form>");
        out.println("</div>");
        out.println("</div>");
